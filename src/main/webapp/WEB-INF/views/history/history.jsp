				...
				<div class="x_content">
					<div class="container" style="padding: 50px;">
						<form:form modelAttribute="searchForm"
							...
							<div class="item form-group">
								<label class="col-form-label col-md-3 col-sm-3 label-align"
									for="productInfo.category.name">Category <span class="required">*</span></label>
								<div class="col-md-6 col-sm-6">
							...
							<div class="item form-group">
								<label class="col-form-label col-md-3 col-sm-3 label-align"
									for="actionName">Action <span class="required">*</span></label>
								<div class="col-md-6 col-sm-6">
...
<script type="text/javascript">
	...
	function processPage() {
		...
		if (indexPage > 1) {
			$('#pagination')
					.append(
							'<li class="page-item"><a class="page-link" href="<c:url value = "/product-in-stock/list/'
									+ (indexPage - 1)
									+ '"/>">Previous</a></li>');
		} else {
			$('#pagination')
					.append(
							'<li class="disabled"><a class="page-link" href="javascript:void(0);">Previous</a></li>');
		}
		if (totalPage < 6) {
			for (var i = 1; i <= totalPage; i++) {
				...
				$('#pagination')
						.append(
								'<li class="page-item '+active+'"><a class="page-link" href= "<c:url value = "/product-in-stock/list/'+i+'"/>">'
										+ i + '</a></li>');
			}
		} else {
			...
			if (indexPage > 2) {
				$('#pagination')
						.append(
								'<li class="page-item"><a class="page-link" href= "<c:url value = "/product-in-stock/list/1"/>">1</a></li>');
				if (indexPage > 3) {
					$('#pagination')
							.append(
									'<li class="out-of-range"><a class="page-link" href="<c:url value = "/product-in-stock/list/'
											+ (indexPage - 2)
											+ '"/>">...</a></li>');
				}
			}
			...
			for (let p = pageCutLow; p <= pageCutHigh; p++) {
				...
				$('#pagination')
						.append(
								'<li class="page-item '+active+'"><a class="page-link" href= "<c:url value = "/product-in-stock/list/'+p+'"/>">'
										+ p + '</a></li>');
			}
			...
			if (indexPage < totalPage - 1) {
				...
				$('#pagination')
						.append(
								'<li class="page-item"><a class="page-link" href="<c:url value = "/product-in-stock/list/'+totalPage+'"/>">'
										+ totalPage + '</a></li>');
			}
		}
		...
		if (indexPage < totalPage) {
			$('#pagination')
					.append(
							'<li class="page-item"><a class="page-link" href= "<c:url value = "/product-in-stock/list/'
									+ (indexPage + 1) + '"/>">Next</a></li>');
		} else {
			$('#pagination')
					.append(
							'<li class="disabled"><a class="page-link" href= "javascript:void(0);">Next</a></li>');
		}
	}
